...
using Raven.Communication.Packets.Incoming.Catalog;
using Raven.Communication.Packets.Incoming.Handshake;
using Raven.Communication.Packets.Incoming.Navigator;
using Raven.Communication.Packets.Incoming.Quests;
using Raven.Communication.Packets.Incoming.Rooms.Avatar;
using Raven.Communication.Packets.Incoming.Rooms.Chat;
using Raven.Communication.Packets.Incoming.Rooms.Connection;
using Raven.Communication.Packets.Incoming.Rooms.Engine;
using Raven.Communication.Packets.Incoming.Rooms.Action;
using Raven.Communication.Packets.Incoming.Users;
using Raven.Communication.Packets.Incoming.Inventory.AvatarEffects;
using Raven.Communication.Packets.Incoming.Inventory.Purse;
using Raven.Communication.Packets.Incoming.Sound;
using Raven.Communication.Packets.Incoming.Misc;
using Raven.Communication.Packets.Incoming.Inventory.Badges;
using Raven.Communication.Packets.Incoming.Avatar;
using Raven.Communication.Packets.Incoming.Inventory.Achievements;
using Raven.Communication.Packets.Incoming.Inventory.Bots;
using Raven.Communication.Packets.Incoming.Inventory.Pets;
using Raven.Communication.Packets.Incoming.LandingView;
using Raven.Communication.Packets.Incoming.Messenger;
using Raven.Communication.Packets.Incoming.Groups;
using Raven.Communication.Packets.Incoming.Rooms.Settings;
using Raven.Communication.Packets.Incoming.Rooms.AI.Pets;
using Raven.Communication.Packets.Incoming.Rooms.AI.Bots;
using Raven.Communication.Packets.Incoming.Rooms.AI.Pets.Horse;
using Raven.Communication.Packets.Incoming.Rooms.Furni;
using Raven.Communication.Packets.Incoming.Rooms.Furni.RentableSpaces;
using Raven.Communication.Packets.Incoming.Rooms.Furni.YouTubeTelevisions;
using Raven.Communication.Packets.Incoming.Help;
using Raven.Communication.Packets.Incoming.Rooms.FloorPlan;
using Raven.Communication.Packets.Incoming.Rooms.Furni.Wired;
using Raven.Communication.Packets.Incoming.Moderation;
using Raven.Communication.Packets.Incoming.Inventory.Furni;
using Raven.Communication.Packets.Incoming.Rooms.Furni.Stickys;
using Raven.Communication.Packets.Incoming.Rooms.Furni.Moodlight;
using Raven.Communication.Packets.Incoming.Inventory.Trading;
using Raven.Communication.Packets.Incoming.GameCenter;
using Raven.Communication.Packets.Incoming.Marketplace;
using Raven.Communication.Packets.Incoming.Rooms.Furni.LoveLocks;
using Raven.Communication.Packets.Incoming.Talents;
using Raven.Communication.Packets.Incoming.Rooms.Camera;
using Raven.Communication.Packets.Incoming.Nucs;
using Raven.Communication.Packets.Incoming.QuickPolls;
using Raven.Communication.Packets.Incoming.Help.Helpers;
using Raven.HabboHotel.Rooms.Instance;
using Raven.Communication.Packets.Incoming.Rooms.Music;
using Raven.Communication.Packets.Incoming.Rooms.Polls;
using Raven.Communication.Packets.Incoming.Calendar;
using Raven.Communication.Packets.Incoming.Groups.Forums;

namespace Raven.Communication.Packets
{
    public sealed class PacketManager
    {
        private static readonly ILog log = LogManager.GetLogger("Raven.Communication.Packets");
        ...
        private void RegisterTalents()
        {
            ...
            //this._incomingPackets.Add(ClientPacketHeader.GetCitizenshipTypeEvent, new GetCitizenshipTypeEvent());
