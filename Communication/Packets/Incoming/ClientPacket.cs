...
namespace Raven.Communication.Packets.Incoming
{
    public class ClientPacket
    {
        ...
        {
            return "[" + Header + "] BODY: " + (RavenEnvironment.GetDefaultEncoding().GetString(Body).Replace(Convert.ToChar(0).ToString(), "[0]"));
        }
        ...
        {
            return RavenEnvironment.GetDefaultEncoding().GetString(ReadFixedValue());
        }
