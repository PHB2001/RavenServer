...
namespace Raven.Communication.Packets.Incoming.Rooms.AI.Pets
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Raven.Communication.Packets.Incoming.Rooms.AI.Pets.PlacePetEvent");
        ...
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            if (Room.GetRoomUserManager().PetCount > RavenStaticGameSettings.RoomPetPlacementLimit)
            {
