...
namespace Raven.Communication.Packets.Outgoing.Messenger
{
    class HabboSearchResultComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.HabboSearchResultMessageComposer)
        {
            ...
            {
                bool Online = (RavenEnvironment.GetGame().GetClientManager().GetClientByUserID(Friend.UserId) != null);
            ...
            {
                bool Online = (RavenEnvironment.GetGame().GetClientManager().GetClientByUserID(OtherUser.UserId) != null);
