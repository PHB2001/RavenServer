...
namespace Raven.Communication.Packets.Outgoing.LandingView
{
    class CommunityGoalComposer : ServerPacket
    {
        ...
        {
            int VOTE_LONG = RavenEnvironment.GetGame().GetCommunityGoalVS().GetLeftVotes();
            int VOTE_SHORT = RavenEnvironment.GetGame().GetCommunityGoalVS().GetRightVotes(); 
            ...
            base.WriteString(RavenEnvironment.GetGame().GetCommunityGoalVS().GetName());
