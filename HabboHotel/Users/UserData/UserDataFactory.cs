...
using Raven.HabboHotel.Users.Authenticator;
    ...
    public class UserDataFactory
    {
        public static UserData GetUserData(string SessionTicket, out byte errorCode)
        {
            ...
            using (IQueryAdapter dbClient = RavenEnvironment.GetDatabaseManager().GetQueryReactor())
            {
                ...
                if (RavenEnvironment.GetGame().GetClientManager().GetClientByUserID(UserId) != null)
                {
                    errorCode = 2;
                    RavenEnvironment.GetGame().GetClientManager().GetClientByUserID(UserId).Disconnect();
                    return null;
                }
            ...
            foreach (DataRow dRow in dFriends.Rows)
            {
                ...
                bool friendHideOnline = RavenEnvironment.EnumToBool(dRow["hide_online"].ToString());
                bool friendHideRoom = RavenEnvironment.EnumToBool(dRow["hide_inroom"].ToString());
            ...
            {
                rooms.Add(RavenEnvironment.GetGame().GetRoomManager().FetchRoomData(Convert.ToInt32(dRow["id"]), dRow));
            }
        ...
        public static UserData GetUserData(int UserId)
        {
            ...
            using (IQueryAdapter dbClient = RavenEnvironment.GetDatabaseManager().GetQueryReactor())
            {
                ...
                RavenEnvironment.GetGame().GetClientManager().LogClonesOut(Convert.ToInt32(UserId));
