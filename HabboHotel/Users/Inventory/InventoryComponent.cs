...
using Raven.HabboHotel.Users.Inventory.Pets;
...
namespace Raven.HabboHotel.Users.Inventory
{
    public class InventoryComponent
    {
        ...
        {
            return RavenEnvironment.GetGame().GetClientManager().GetClientByUserID(_userId);
        }
