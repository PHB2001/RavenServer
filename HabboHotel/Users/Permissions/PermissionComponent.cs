...
namespace Raven.HabboHotel.Users.Permissions
{
    /// <summary>
    ...
    public sealed class PermissionComponent
    {
        ...
        public bool Init(Habbo Player)
        {
            ...
            this._permissions.AddRange(RavenEnvironment.GetGame().GetPermissionManager().GetPermissionsForPlayer(Player));
            this._commands.AddRange(RavenEnvironment.GetGame().GetPermissionManager().GetCommandsForPlayer(Player));
            return true;
        }
