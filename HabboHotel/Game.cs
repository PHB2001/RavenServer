...
using Raven.Communication.Packets;
...
using Raven.HabboHotel.Rooms.Chat;
using Raven.HabboHotel.Talents;
using Raven.HabboHotel.Bots;
using Raven.HabboHotel.Cache;
using Raven.HabboHotel.Rewards;
using Raven.HabboHotel.Badges;
using Raven.HabboHotel.Permissions;
using Raven.HabboHotel.Subscriptions;
using System.Threading;
using System.Threading.Tasks;
using Raven.HabboHotel.Camera;
using Raven.HabboHotel.Catalog.FurniMatic;
...
using Raven.HabboHotel.LandingView.CommunityGoal;
using Raven.WebSockets;
//using Raven.HabboHotel.Alphas;

namespace Raven.HabboHotel
{
    public class Game
    {
        private static readonly ILog log = LogManager.GetLogger("Raven.HabboHotel.Game");
        ...
        private void GameCycle()
        {
            while (this._cycleActive)
            {
                ...
                RavenEnvironment.GetGame().GetRoomManager().OnCycle();
                RavenEnvironment.GetGame().GetClientManager().OnCycle();
        ...
        internal object GetSettingsManager()
        {
            throw new NotImplementedException();
        }
    }
