...
namespace Raven.HabboHotel.Rooms
{
    public class RoomData
    {
        ...
        public void Fill(DataRow Row)
        {
            ...
            Group G = null;
            if (RavenEnvironment.GetGame().GetGroupManager().TryGetGroup(Convert.ToInt32(Row["group_id"]), out G))
                Group = G;
            else
                Group = null;
            ...
            mModel = RavenEnvironment.GetGame().GetRoomManager().GetModel(ModelName);

            this.PushEnabled = RavenEnvironment.EnumToBool(Row["push_enabled"].ToString());
            this.PullEnabled = RavenEnvironment.EnumToBool(Row["pull_enabled"].ToString());
            this.SPushEnabled = RavenEnvironment.EnumToBool(Row["spush_enabled"].ToString());
            this.SPullEnabled = RavenEnvironment.EnumToBool(Row["spull_enabled"].ToString());
            this.EnablesEnabled = RavenEnvironment.EnumToBool(Row["enables_enabled"].ToString());
            this.RespectNotificationsEnabled = RavenEnvironment.EnumToBool(Row["respect_notifications_enabled"].ToString());
            this.PetMorphsAllowed = RavenEnvironment.EnumToBool(Row["pet_morphs_allowed"].ToString());
            this.Shoot = Convert.ToInt32(Row["shoot"]);
            this.HideWired = RavenEnvironment.EnumToBool(Row["hide_wired"].ToString());
