...
{
    class Premiar4Command : IChatCommand
    {
        ...
        public void Execute(GameClient Session, Room Room, string[] Params)
        {
            ...
            if (Params.Length == 4)
            {
                Session.SendWhisper("Por favor introduce 4 nombres de usuarios para premiar.", 34);
                return;
            }
            ...
            GameClient Target4 = RavenEnvironment.GetGame().GetClientManager().GetClientByUsername(Params[4]);
            ...
            if (Target4 == null)
            {
                Session.SendWhisper("Oops, No se ha conseguido este usuario " + Params[4] + "!");
                return;
            }
            ...
            RoomUser TargetUser4 = Room.GetRoomUserManager().GetRoomUserByHabbo(Target4.GetHabbo().Id);
            ...
            if (TargetUser4 == null)
            {
                Session.SendWhisper("Usuario no encontrado! " + Params[4] + " tal vez no esté en línea o en esta sala.");
                return;
            }
            ...
            if (Target4.GetHabbo().Username == Session.GetHabbo().Username)
            {
                Session.SendWhisper("Men no seas estupid@, no puedes premiarte tu mismo!");
                return;
            }
            ...
            Target4.SendMessage(RavenEnvironment.GetGame().GetNuxUserGiftsManager().NuxUserGifts.Serialize());
            ...
            string figure4 = Target4.GetHabbo().Look;
            ...
            RavenEnvironment.GetGame().GetClientManager().SendMessage(RoomNotificationComposer.SendBubble("fig/" + figure4, TargetUser4.GetUsername() + " ha ganado un evento en el hotel. Felicitaciones!", ""));
            Session.SendWhisper("Has activado correctamente el premio para " + Target4.GetHabbo().Username, 34);
