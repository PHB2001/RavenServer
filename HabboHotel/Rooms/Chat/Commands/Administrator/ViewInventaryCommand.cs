    ...
    class ViewInventaryCommand : IChatCommand
    {
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            if (Params.Length == 2)
            {
                ...
                GameClient Client = RavenEnvironment.GetGame().GetClientManager().GetClientByUsername(Username);
                if (Client != null)
                {
                ...
                int UserId = RavenEnvironment.GetGame().GetClientManager().GetUserIdByUsername(Username);
                if (UserId == 0)
                {
