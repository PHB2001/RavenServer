...
using Raven.HabboHotel.Rooms.Chat.Commands.User;
using Raven.HabboHotel.Rooms.Chat.Commands.User.Fun;
using Raven.HabboHotel.Rooms.Chat.Commands.Moderator;
using Raven.HabboHotel.Rooms.Chat.Commands.Moderator.Fun;
using Raven.HabboHotel.Rooms.Chat.Commands.Administrator;

using Raven.Communication.Packets.Outgoing.Rooms.Chat;
using Raven.Communication.Packets.Outgoing.Notifications;
using Raven.Database.Interfaces;
using Raven.HabboHotel.Rooms.Chat.Commands.Events;
using Raven.HabboHotel.Items.Wired;
using Raven.Communication.Packets.Outgoing.Rooms.Notifications;
using Raven.HabboHotel.Rooms.Chat.Commands.User.Fan;
...
namespace Raven.HabboHotel.Rooms.Chat.Commands
{
    public class CommandManager
    {
        ...
        {
            if (Session == null || Session.GetHabbo() == null || Session.GetHabbo().CurrentRoom == null || RavenStaticGameSettings.IsGoingToBeClose)
                return false;
        ...
        private void RegisterUser()
        {
            ...
            this.Register("cerrardado", new CloseDiceCommand());
            ...
            this.Register("andre", new CustomLegit());
        ...
        private void RegisterModerator()
        {
            ...
            this.Register("oleada", new PubliAlertCommand());
            this.Register("evento", new GameAlertCommand());
            ...
            this.Register("ranks", new GiveRanksCommand());
        }
        ...
        private void RegisterAdministrator()
        {
            ...
            this.Register("premiar1", new PremiarCommand());
            this.Register("premiar2", new Premiar2Command());
            this.Register("premiar3", new Premiar3Command());
            this.Register("premiar4", new Premiar4Command());
            this.Register("p1", new PremiarCommand());
            this.Register("p2", new Premiar2Command());
            this.Register("p3", new Premiar3Command());
            this.Register("p4", new Premiar4Command());
            ...
            this.Register("radioalert", new DJAlert2());
            this.Register("radioalert2", new DJAlert());
            this.Register("radio", new DJAlert2());
            this.Register("radio2", new DJAlert());
            this.Register("dj2", new DJAlert());
            this.Register("dj", new DJAlert2());
        ...
        public void LogCommand(int UserId, string Data, string MachineId, string Username)
        {
            ...
            { return; }
                ...
                RavenEnvironment.GetGame().GetClientManager().ManagerAlert(RoomNotificationComposer.SendBubble("advice", "" + Username + "\n\nUsó el comando:\n:" + Data + ".", ""));
        }
