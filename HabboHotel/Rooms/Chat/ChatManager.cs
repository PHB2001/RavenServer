...
using Raven.HabboHotel.Rooms.Chat.Logs;
using Raven.HabboHotel.Rooms.Chat.Filter;
using Raven.HabboHotel.Rooms.Chat.Emotions;
using Raven.HabboHotel.Rooms.Chat.Commands;
using Raven.HabboHotel.Rooms.Chat.Pets.Commands;
using Raven.HabboHotel.Rooms.Chat.Pets.Locale;
using log4net;
using Raven.HabboHotel.Rooms.Chat.Styles;

namespace Raven.HabboHotel.Rooms.Chat
{
    public sealed class ChatManager
    {
        private static readonly ILog log = LogManager.GetLogger("Raven.HabboHotel.Rooms.Chat.ChatManager");
