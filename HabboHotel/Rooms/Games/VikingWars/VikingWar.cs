...
//using Raven.Utilities.Enclosure;
//using System.Linq;
...
//namespace Raven.HabboHotel.Rooms.Games.VikingWars
//{
...
//                    {
//                        if (RavenEnvironment.GetUnixTimestamp() - timestarted > 5)
//                        {
//                            RavenEnvironment.GetGame().GetAchievementManager().ProgressAchievement(User.GetClient(), "ACH_BattleBallTilesLocked", User.LockedTilesCount);
//                            RavenEnvironment.GetGame().GetAchievementManager().ProgressAchievement(User.GetClient(), "ACH_BattleBallPlayer", 1);
//                        }
//                    }
...
//                        {
//                            if (RavenEnvironment.GetUnixTimestamp() - timestarted > 5)
//                                RavenEnvironment.GetGame().GetAchievementManager().ProgressAchievement(User.GetClient(), "ACH_BattleBallWinner", 1);
