...
namespace Raven.HabboHotel.Rooms.AI
{
    public class Pet
    {
        public int PetId;
        ...
        public Room Room
        {
            get
            {
                ...
                if (RavenEnvironment.GetGame().GetRoomManager().TryGetRoom(RoomId, out _room))
                    return _room;
                else
                    return null;
        ...
        public int Age
        {
            get { return Convert.ToInt32(Math.Floor((RavenEnvironment.GetUnixTimestamp() - CreationStamp) / 86400)); }
        }
        ...
        {
            get { return RavenEnvironment.GetGame().GetClientManager().GetNameById(OwnerId); }
        }
    }
