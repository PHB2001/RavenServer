...
namespace Raven.HabboHotel.Rooms.AI.Types
{
    public class PetBot : BotAI
    {
        ...
        public override void OnSelfEnterRoom()
        {
            ...
            //int randomX = RavenEnvironment.GetRandomNumber(0, GetRoom().Model.MapSizeX);
            //int randomY = RavenEnvironment.GetRandomNumber(0, GetRoom().Model.MapSizeY);
            if (GetRoomUser() != null)
        ...
        public override void OnUserEnterRoom(RoomUser User)
        {
            if (User.GetClient() != null && User.GetClient().GetHabbo() != null)
            {
                ...
                if (Pet != null)
                {
                    ...
                    {
                        string[] Speech = RavenEnvironment.GetGame().GetChatManager().GetPetLocale().GetValue("welcome.speech.pet" + Pet.PetData.Type);
        ...
        public override void OnUserSay(RoomUser User, string Message)
        {
            ...
            if ((Message.ToLower().StartsWith(Pet.PetData.Name.ToLower() + " ") && User.GetClient().GetHabbo().Username.ToLower() == Pet.PetData.OwnerName.ToLower()) || (Message.ToLower().StartsWith(Pet.PetData.Name.ToLower() + " ") && RavenEnvironment.GetGame().GetChatManager().GetPetCommands().TryInvoke(Message.Substring(Pet.PetData.Name.ToLower().Length + 1).ToLower()) == 8))
            {
                string Command = Message.Substring(Pet.PetData.Name.ToLower().Length + 1);

                int r = RandomNumber.GenerateRandom(1, 8); // Made Random
                if (Pet.PetData.Energy > 10 && r < 6 || Pet.PetData.Level > 15 || RavenEnvironment.GetGame().GetChatManager().GetPetCommands().TryInvoke(Command) == 8)
                {
                    RemovePetStatus(); // Remove Status

                    switch (RavenEnvironment.GetGame().GetChatManager().GetPetCommands().TryInvoke(Command))
                    {
                        #region free
                        ...
                        default:
                            string[] Speech = RavenEnvironment.GetGame().GetChatManager().GetPetLocale().GetValue("pet.unknowncommand");
                ...
                else
                {
                    ...
                    {
                        string[] Speech = RavenEnvironment.GetGame().GetChatManager().GetPetLocale().GetValue("pet.tired");
                    ...
                    {
                        string[] Speech = RavenEnvironment.GetGame().GetChatManager().GetPetLocale().GetValue("pet.lazy");
