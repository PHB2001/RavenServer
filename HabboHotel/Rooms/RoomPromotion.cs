...
namespace Raven.HabboHotel.Rooms
{
    public class RoomPromotion
    {
        ...
        {
            get { return (this.TimestampExpires - RavenEnvironment.GetUnixTimestamp()) < 0; }
        }

        public int MinutesLeft
        {
            get { return Convert.ToInt32(Math.Ceiling((this.TimestampExpires - RavenEnvironment.GetUnixTimestamp()) / 60)); }
        }
