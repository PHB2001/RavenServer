...
using Raven.HabboHotel.Items.Wired.Boxes.Triggers;

using Raven.HabboHotel.Items.Wired.Boxes.Effects;
using Raven.HabboHotel.Items.Wired.Boxes.Conditions;
using Raven.HabboHotel.Items.Wired.Boxes.Add_ons;

using Raven.Database.Interfaces;
using System.Drawing;

namespace Raven.HabboHotel.Rooms.Instance
{
    public class WiredComponent
    {
        ...
        {
            return this._wiredItems.TryRemove(ItemId, out IWiredItem Item);
        }
