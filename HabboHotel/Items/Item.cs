...
using Raven.HabboHotel.Items.Interactor;
...
namespace Raven.HabboHotel.Items
{
    ...
    public class Item
    {
        ...
        {
            ItemData Data = null;
            if (RavenEnvironment.GetGame().GetItemManager().GetItem(BaseItem, out Data))
            {
                this.Id = Id;
                this.RoomId = RoomId;
                this._room = Room;
                ...
                this.UserID = Userid;
                this.Username = RavenEnvironment.GetUsernameById(Userid);
                                            ...
                                            if (ItemTeleporterFinder.IsTeleLinked(Id, GetRoom()))
                                            {
                                                ...
                                                if (true)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        //RavenEnvironment.GetGame().GetRoomManager().AddTeleAction(new TeleUserData(User.GetClient().GetMessageHandler(), User.GetClient().GetHabbo(), RoomId, TeleId));
                                                    }
                        ...
                        case InteractionType.DICE:
                            {
                                ...
                                UpdateState();
                                //left off here
                                RavenEnvironment.GetHabboById(InteractingUser).casinoEvent(ExtraData);
        ...
        public ItemData GetBaseItem()
        {
            ...
            {
                ItemData I = null;
                if (RavenEnvironment.GetGame().GetItemManager().GetItem(this.BaseItem, out I))
                    this._data = I;
            }
