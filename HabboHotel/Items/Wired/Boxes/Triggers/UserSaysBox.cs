...
namespace Raven.HabboHotel.Items.Wired.Boxes.Triggers
{
    class UserSaysBox : IWiredItem
    {
        ...
        public bool Execute(params object[] Params)
        {
            ...
            if (Message.ToLower().Contains(" " + this.StringData.ToLower()) || Message.ToLower().Contains(" " + this.StringData.ToLower() + " ") || Message.ToLower().Contains(this.StringData.ToLower() + " ") || Message.ToLower().Contains(this.StringData.ToLower()))
            {
