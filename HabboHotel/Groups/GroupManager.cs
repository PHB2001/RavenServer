...
namespace Raven.HabboHotel.Groups
{
    public class GroupManager
    {
        private static readonly ILog log = LogManager.GetLogger("Raven.HabboHotel.Groups.GroupManager");
            ...
            lock (this._groupLoadingSync)
            {
                ...
                using (IQueryAdapter dbClient = RavenEnvironment.GetDatabaseManager().GetQueryReactor())
                {
                    ...
                    if (Row != null)
                    {
                        ...
                        catch { created = RavenEnvironment.GetIUnixTimestamp(); }
                        Group = new Group(
        ...
        {
            Group = new Group(0, Name, Description, Badge, RoomId, Player.Id, (int)RavenEnvironment.GetUnixTimestamp(), 0, Colour1, Colour2, 0, false, false);
