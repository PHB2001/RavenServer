...
namespace Raven.HabboHotel.Groups.Forums
{
    public class GroupForumThread
    {
        ...
        {
            return RavenEnvironment.GetHabboById(UserId);
        }

        public Habbo GetDeleter()
        {
            return RavenEnvironment.GetHabboById(DeleterUserId);
        }
        ...
        public void SerializeData(GameClient Session, ServerPacket Packet)
        {
            ...
            Packet.WriteInteger((int)(RavenEnvironment.GetUnixTimestamp() - Timestamp)); //Created Secs Ago
            ...
            Packet.WriteInteger(!isn ? (int)(RavenEnvironment.GetUnixTimestamp() - lastpost.Timestamp) : 0); //Last message timestamp
            ...
            if (deleter != null)
            {
                ...
                Packet.WriteInteger((int)(RavenEnvironment.GetUnixTimestamp() - DeletedTimestamp));//deleted secs ago
            }
            else
            {
