...
namespace Raven.HabboHotel.Calendar
{
    public class CalendarManager
    {
        private static readonly ILog log = LogManager.GetLogger("Raven.HabboHotel.Calendar.CalendarManager");
        ...
        {
            int Time = (int)(RavenEnvironment.GetUnixTimestamp() - StartUnix);
