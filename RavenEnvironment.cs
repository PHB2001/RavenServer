...
using Raven.Communication.Encryption.Keys;
using Raven.Communication.Encryption;
...
namespace Raven
{
    public static class RavenEnvironment
    {
        private static readonly ILog log = LogManager.GetLogger("Raven.RavenEnvironment");

        public const string PrettyVersion = "Raven Emulator";
        public const string PrettyBuild = "3.8";
        public const string HotelName = "Mabbi";
        ...
        public static void Initialize()
        {
            ...
            Console.WriteLine("             Agradecimientos a » @SergioT @Sledmore @Finn @XDR @CarlosD");
            Console.WriteLine("");
            ...
            try
            {
                ...
                log.Info(">> RAVEN SERVER -> READY! (" + TimeUsed.Seconds + " s, " + TimeUsed.Milliseconds + " ms)");
            }
